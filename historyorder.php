            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        $getData = "SELECT * FROM tb_list_order WHERE kode_order = '$idOrder'";
                    ...
                    <tr >
                        ...
                        <td >
                            <div class="d-flex">
                            <a class="btn btn-info btn-sm me-1" href="./?x=orderhistorydetail&order=<?php echo $row['id_order']."&pelanggan=".$row['pelanggan']."&address=".$row['address']."&hp=".$row['hp'] ?>"><i class="bi bi-eye"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php 
